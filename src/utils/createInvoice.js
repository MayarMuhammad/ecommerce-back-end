...
function generateHeader(doc) {
  doc
    ...
    .fillColor("#444444")
    .fontSize(20)
    .text("Mayar Company", 110, 57)
    .fontSize(10)
    .text("Mayar Company", 200, 50, { align: "right" })
    .text("El Seyoof", 200, 65, { align: "right" })
...
function generateCustomerInformation(doc, invoice) {
  ...
  doc
    ...
    .font("Helvetica-Bold")
    .text(invoice.customer.username, 400, customerInformationTop)
    .font("Helvetica")
